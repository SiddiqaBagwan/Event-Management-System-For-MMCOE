...
<body>
  ...
  <nav id="nav">
    ...
    <div class="nav-right">
      ...
      <!--theme toggle-->
      <div class="theme-btn" id="themeBtn" onclick="toggleTheme()" title="Toggle theme">
        <span class="theme-icon-d">
          <img src="/campus/icons/moon.png" class="icon-img" alt="🌙" />
        </span>
        <span class="theme-icon-l">
          <img src="/campus/icons/sun.png" class="icon-img" alt="☀️" />
        </span>
      </div>
